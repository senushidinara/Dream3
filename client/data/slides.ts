export type Slide = {
  ...
  hotspots?: Array<{ x: number; y: number; w: number; h: number; action: string; id: string }>;
};
...
export const slides: Slide[] = [
  {
    ...
    body:
      "Explore The Mind Palace for self-discovery and imaginative adventures. Hidden treasures, puzzles, and dream fragments await.",
  ...
  },
  {
    ...
    title: "Welcome",
    body:
      "Embark on a transformative journey through The Mind Palace, where imagination fuels self-discovery and personal growth in an interactive quest.",
  ...
  },
  {
    ...
    body:
      "Unlock your imagination by exploring dreamscapes and solving engaging puzzles. Every fragment collected is growth.",
  ...
  },
  {
    ...
    body:
      "Discover hidden vision shards and unlock the secrets of each island through exploration and creativity.",
    bg: "https://cdn.builder.io/api/v1/image/assets%2Fdc3782de61224ee6afee73d63ac0f50c%2F8bf82fb537c0431186b162ded994138f?format=webp&width=1600",
    contentType: "gallery",
    hotspots: [{ x: 18, y: 12, w: 16, h: 28, action: "collect", id: "frag-island-1" }],
  },
  {
    id: "gallery",
  ...
  },
  {
    ...
    contentType: "game",
    game: "unscramble",
    hotspots: [{ x: 75, y: 68, w: 12, h: 12, action: "collect", id: "frag-library-1" }],
  },
  {
    id: "fragments",
    ...
    bg: "https://cdn.builder.io/api/v1/image/assets%2Fdc3782de61224ee6afee73d63ac0f50c%2F8bf82fb537c0431186b162ded994138f?format=webp&width=1600",
    contentType: "text",
    hotspots: [{ x: 12, y: 40, w: 10, h: 10, action: "collect", id: "frag-frag-1" }],
  },
  {
    id: "goal",
    title: "Experience Goal",
    body:
      "The quest for self-discovery drives personal growth. Collect fragments, explore, and shape your story-world.",
    bg: "https://cdn.builder.io/api/v1/image/assets%2Fdc3782de61224ee6afee73d63ac0f50c%2Fe45a2631e64b47ae8e8c114df4f07d02?format=webp&width=1600",
    contentType: "text",
  },
  {
    ...
    bg: "https://cdn.builder.io/api/v1/image/assets%2Fdc3782de61224ee6afee73d63ac0f50c%2F81a3bef5f3f84a4388de1249f2fc6d07?format=webp&width=1600",
    contentType: "text",
    hotspots: [{ x: 84, y: 60, w: 12, h: 12, action: "collect", id: "frag-join-1" }],
  },
];
