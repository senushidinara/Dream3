        ...
        <div className="mx-auto max-w-7xl px-4 pt-16 pb-14">
          ...
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-foreground/80 max-w-2xl mx-auto">
              A living world of imagination. Explore dreamscapes, interact with
              living artifacts, and collect fragments that shape your journey.
            </p>
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              <Link
                to="/islands"
                className="px-5 py-2.5 rounded-md bg-gradient-to-r from-primary to-accent text-primary-foreground shadow hover:shadow-lg"
              >
                Explore Islands
              </Link>
              <Link
                to="/gallery"
                className="px-5 py-2.5 rounded-md bg-secondary text-secondary-foreground hover:opacity-90"
              >
                Visit Galleries
              </Link>
              <Link
                to="/library"
                className="px-5 py-2.5 rounded-md bg-muted hover:bg-muted/80"
              >
                Memory Library
              </Link>
              <Link
                to="/presentation"
                className="px-5 py-2.5 rounded-md bg-primary/10 text-primary border border-primary/30"
              >
                View Presentation
              </Link>
            </div>
            <div className="mt-4 text-sm text-muted-foreground">
              Progress • {fragments} Fragments · {shards} Shards · {keys} Keys
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="rounded-2xl border border-border/50 p-6 bg-card/50">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Navigate shimmering islands. Touch a crystal to enter — but first,
              answer its riddle.
            </p>
            <div className="mt-4 flex gap-2">
              <Link
                className="px-3 py-1.5 rounded-md bg-primary/20 text-primary"
                to="/islands"
              >
                Open Map →
              </Link>
          ...
          <div className="rounded-2xl border border-border/50 p-6 bg-card/50">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Objects are portals. Play a short rhythm or paint with color to
              reveal hidden art.
            </p>
            <div className="mt-4">
              <RhythmGame />
          ...
          <div className="rounded-2xl border border-border/50 p-6 bg-card/50">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Solve a memory puzzle or choose a reflection that resonates. Keys
              open secret chambers.
            </p>
            <div className="mt-4">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20">
        <div className="rounded-2xl border border-border/50 p-8 bg-card/40 relative overflow-hidden">
          ...
          <p className="mt-2 text-foreground/80 max-w-2xl">
            Hidden across all islands, galleries, and tomes. Gather enough and
            watch your Dream Constellation Map ignite with light.
          </p>
          <div className="mt-6 flex flex-wrap gap-3">
            <Link
              to="/constellation"
              className="px-4 py-2 rounded-md bg-gradient-to-r from-primary to-accent text-primary-foreground"
            >
              View Constellation
            </Link>
            <Link
